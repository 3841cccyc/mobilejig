            ...
            <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-5xl">
                        {difficulties.map((difficulty) => {
                            ...
                            return (
                                <Card
                                    key={difficulty.id}
                                    className={`cursor-pointer transition-all duration-300 h-full ${isSelected
                ...
                <div className="flex justify-center gap-4 mb-8">
                    <Button
                        ...
                        className="bg-primary hover:bg-primary/90 text-lg px-8 py-3 min-w-[200px]"
                    >
                    ...
                    <Button
                        ...
                        className="bg-card/80 backdrop-blur-sm text-lg px-8 py-3 min-w-[200px]"
                    >
                        查看排行榜
                    </Button>
                </div>
